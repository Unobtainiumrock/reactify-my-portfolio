...
const renderAboutMe = () => {
  ...
  <div class="row" id="landing">
    <div class="col-md-3">
      <img class="animated fadeIn" id="prof-pic" src="src/images/profile-pic.jpg" height="350px" width="270px">
    </div>

    <div class="col-md-9">
      <p class="animated fadeIn paragraph-format">
  ...
  <div class="row">
    <div class="col-md-6">
      <img class="icon" src="src/images/GitHub.svg" data-url="https://github.com/Unobtainiumrock" height="70px" length="70px style="color: white">
      <img class="icon" src="src/images/lknd.png" data-url="https://www.linkedin.com/in/unobtainiumrock/" height="70px" length="70px style="color: white">
    </div>
